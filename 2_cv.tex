...
\ins{snippets/cv_udel.tex}
\ins{snippets/cv_columbia}
\ins{snippets/cv_pnc_smart}
\end{rSection}
...
\ins{snippets/list_publications}
\end{rSection}
...
\ins{snippets/list_presentations}
\end{rSection}
